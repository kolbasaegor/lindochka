...
class Manager(object):
    ...
    def thunk(self, fun, client, fun_args):
        """
    ...
    def handle_eval(self, pid, tup):
        ...
        proc = multiprocessing.Process(target=self.thunk, args=(tup[0], client, tup[1]))
        proc.start()
...
class Client(object):
    ...
    def eval(self, fun, *fun_args):
        ...
        """
        self.pipe.send(('eval', (fun, fun_args,)))
